...
const iconMap: Record<string, JSX.Element> = {
  Lock: <Lock className="w-6 h-6 text-brand-gold" />,
  Search: <Search className="w-6 h-6 text-brand-gold" />,
  Scale: <Scale className="w-6 h-6 text-brand-gold" />,
  CheckCircle: <CheckCircle className="w-6 h-6 text-brand-gold" />,
};
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute left-0 md:left-1/2 md:-translate-x-1/2 w-16 h-16 bg-brand-navy/80 backdrop-blur-md rounded-full border border-brand-gold/40 flex items-center justify-center z-10 shadow-[0_0_20px_rgba(212,175,55,0.4)]">
                    {/* Renderiza o ícone baseado no nome armazenado na config */}
